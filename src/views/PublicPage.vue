...
<template>
  <div>
    <div style="text-align: center; padding-top: 100px;">
      <h1 style="text-decoration-color: black; font-size: 30px; font-weight: bold">Sample public design</h1>
      <p style="color: #5d5d5d; padding: 30px; border-bottom: 1px solid gray ; ">Some description</p>
    </div>
    <div class="px-20 w-full">
      <ScreenView v-if="!isUpload" class="mb-10" ref="screenview" />
      <ImageUpload v-else />
      <div v-if="getSpacesCount === 0" class="welcome-page">
        <div class="welcome-holder">
          <div class="welcome-box-holder">
            <span class="welcome-title">Welcome, let's get started...</span>
            <ul class="welcome-box-nav">
              <li class="video-icon">
                <a href="" id="playVideoBtn">
                  <span>Brief Intro</span>
                  <em>New here? Watch a quick 'Get Started' Video.</em>
                </a>
              </li>
              <li class="mobile-icon">
                <!-- <a href="https://projects.savahapp.com/io.do?key=pf9BChVK" target="_blank">
                    <span class="red-color">Help Centre </span>
                    <em>Advice and answers from a Savah Team.</em>
                </a> -->
              </li>
            </ul>
            <div class="text-center create-project-link">
              <div v-ripple="'rgba(0, 0, 0, 0.05)'" class="py-4 px-4 border-t border-b border-white-three" onclick="document.getElementById('btnCreateSpace').click();"  style="max-height: 67px; cursor: pointer;">
